...
# class BlogForm(Form):
#     """
#     This Form class contains all of the fields that make up our blog form
#     """
#     #Get all of the text fields out of the way.
#     title_field = StringField(
#             label="Title", default="post title",
#             validators=[Required(), Length(1,180)])
#     post_field = TextAreaField(
#             label="Post", default='blog post',
#             validators=[Required()])
#     # translate_field = TextField(
#     #         label="Translate", default="wi",
#     #         validators=[validators.length(max=256)])
#     trandate_field = StringField(
#             label="Post Date")
#     active_field = IntegerField(
#             label="Active")
#     # Now let's set all of our select fields.
#     author_select_field = SelectField(label="Author", coerce=int)
#     # language_select_field = SelectField(label="Language", coerce=int)
